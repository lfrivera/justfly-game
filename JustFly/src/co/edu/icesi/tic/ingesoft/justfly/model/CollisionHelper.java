...
public class CollisionHelper {
	...
	{
		double xDif = a.getPosition().x - b.getPosition().x;
	    double yDif = a.getPosition().y - b.getPosition().y;

	    double distanceSquared = (xDif * xDif) + (yDif * yDif);
	    
	    boolean collision = distanceSquared <= Math.pow((a.getRadius()+b.getRadius()), 2);
